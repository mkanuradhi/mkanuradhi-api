...
const blogPostSchema = new Schema<BlogPostDocument>(
  {
    ...
    titleSi: {
      ...
      trim: true,
      unique: true,
      required: [true, 'Blog title in Sinhala is required.'],
    ...
    summarySi: {
      type: String,
      trim: true,
      required: [true, 'Summary in Sinhala is required.'],
    ...
    contentSi: {
      type: String,
      trim: true,
      required: [true, "Content in Sinhala is required."],
    ...
    pageDescriptionSi: {
      type: String,
      trim: true,
      required: [true, "Page description in Sinhala is required."],
